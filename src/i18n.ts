...
const appTranslations: Record<Locale, Record<string, string>> = {
  'zh-CN': {
    ...
    'app.downloadFullJson': '导出完整 JSON',
    'app.importJson': '导入 JSON',
    'app.importHint': '导入现有配置文件后，可以继续在表单里编辑。',
    'app.saveModule': '保存当前模块',
    'app.resetModule': '重置当前模块',
    'app.moduleSelect': '第一级配置模块',
    'app.language': '语言',
    'app.importInvalidFormat': '导入失败：JSON 不是一个对象。',
    'app.importParseFailed': '导入失败：JSON 解析失败。',
  ...
  'en-US': {
    ...
    'app.downloadFullJson': 'Export Full JSON',
    'app.importJson': 'Import JSON',
    'app.importHint': 'Import an existing config file and continue editing it in the form.',
    'app.saveModule': 'Save Module',
    'app.resetModule': 'Reset Module',
    'app.moduleSelect': 'Top-level Module',
    'app.language': 'Language',
    'app.importInvalidFormat': 'Import failed: the JSON is not an object.',
    'app.importParseFailed': 'Import failed: failed to parse JSON.',
